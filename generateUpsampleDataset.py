...
if not os.path.exists('pngResampled1000'):
    os.makedirs('pngResampled1000')
os.chdir('pngResampled1000')
...
for i in range (200,256):
    ...
    tmp2 = create_image(desiredMean, height, width, minPixelBrightness, maxPixelBrightness, desiredPrecision, num_of_images = 1000)
