...
train_filename = 'test256classSimple10000'
test_filename = 'test256classSimple10000'
...
train_datasets, trainDataset, labelsTrainDataset = Merge_folders(train_folders, 100)
