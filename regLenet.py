...
#pickle_file = 'trainSimple26classReg.pickle'
#pickle_file = 'train52classSim10000Reg.pickle'
#pickle_file = 'trainSimple10class20000Reg.pickle'
#pickle_file = 'train6class60000SimpleReg.pickle'
pickle_file = 'br26class10000Reg.pickle'
...
with tf.Session(graph=graph) as session:
  ...
  print('Test dataset medan regression error: %.5f' % meanSqr(test_prediction.eval(), test_labels))
